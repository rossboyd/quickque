...
export function SettingsDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] md:max-w-[800px] lg:max-w-[900px] w-[95vw] max-h-[90vh] overflow-y-auto bg-background border-border">
        <DialogHeader>
          <DialogTitle className="text-xl">Settings & Help</DialogTitle>
          <DialogDescription>Device preferences, library backups and presentation defaults.</DialogDescription>
        </DialogHeader>
