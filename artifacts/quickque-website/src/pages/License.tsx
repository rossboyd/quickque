  ...
  return (
    <div className="max-w-3xl mx-auto w-full px-4 py-16">
      ...
      <section className="mb-10 space-y-5 leading-relaxed">
        ...
        <p><strong>Lifetime:</strong> {config?.commerce?.displayPrice} once for permanent access to unlimited Voice Follow and saved AI audio features in Quickque for Mac, with no recurring charge. One year of updates is included. After that, you keep access to versions released during your update period. Newer versions require renewed update coverage; renewing is optional. Separate future products or services are not included. This is a permanent feature entitlement, not a promise of perpetual support or compatibility with every future operating system.</p>
